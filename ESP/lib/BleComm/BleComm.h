...
typedef struct
{
  ...
  PAYLOAD_CMD_SERVO_CLAW_SET_ANGLE, PAYLOAD_RESP_SERVO_CLAW_GET_ANGLE;

typedef struct
{
    uint8_t channel;
} PAYLOAD_CMD_SERVO_GET_ANGLE, PAYLOAD_CMD_SERVO_GET_PULSE_WIDTH,
  PAYLOAD_CMD_SERVO_CLAW_GET_ANGLE, PAYLOAD_CMD_SERVO_CLAW_GET_PULSE_WIDTH;
...
typedef struct
{
  ...
  PAYLOAD_CMD_SERVO_CLAW_SET_PULSE_WIDTH, PAYLOAD_RESP_SERVO_CLAW_GET_PULSE_WIDTH;
...
enum CMD_SERVO {
    ...
    CMD_SERVO_CLAW_SET_ANGLE,
    CMD_SERVO_CLAW_GET_ANGLE,
    CMD_SERVO_CLAW_SET_PULSE_WIDTH,
    CMD_SERVO_CLAW_GET_PULSE_WIDTH
};
